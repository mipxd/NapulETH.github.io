...
function Hero() {
    ...
    return (
        <section className="w-full h-fit relative flex flex-col items-center justify-start pt-32 lg:pt-40">
            ...
            <h5 className=" text-black text-3xl lg:text-5xl SemiBold lg:leading-normal text-center relative z-50">
                The First Web3 Event<br />in Naples
            </h5>
            <p className=" text-[#2E2E2E] Medium lg:mt-0 text-center lg:text-left text-2xl lg:text-3xl mt-6 relative z-50">
                12th - 14th September, 2024
            </p>
            <p className=" text-[#2E2E2E] Medium text-center lg:text-left text-2xl lg:text-3xl mt-2 relative z-50s">
            ...
            <div className="w-fit h-fit flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-3 mt-6 lg:mt-10">
                <Link href={'/tickets'} className=" relative z-50 p-0 w-fit h-fit">
                    <div className="min-w-[75vw] lg:min-w-[15vw] h-fit flex flex-row items-center justify-center gap-2 py-4 px-12 bg-[#CA75AB] buttonShadow ">
