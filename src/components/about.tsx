...
function About() {
    ...
    return (
        <section className="w-full h-fit relative flex flex-col items-center justify-start pt-16 lg:pt-40">
            ...
            <h5 className=" text-black text-4xl SemiBold leading-normal text-center mt-20 mb-3">
            {t('abouttitle')}
            </h5>
            <h5 className=" text-black text-2xl Medium leading-normal text-center">
            {t('aboutsubtitle')}
            </h5>
            <p className=" text-[#2E2E2E] Medium text-2xl lg:text-3xl text-center leading-normal mt-8 lg:mt-20 w-11/12 lg:w-7/12">
            {t('aboutpara1')}
            </p>
            <p className=" text-[#2E2E2E] Medium text-2xl lg:text-3xl text-center leading-normal mt-8 w-11/12 lg:w-7/12">
            {t('aboutpara2')}
            </p>
        </section>
    )
