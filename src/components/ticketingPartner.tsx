...
function TicketingPartner() {
    return (
        <section className="w-full flex flex-col items-center justify-start pt-40">
            ...
            <div className="w-8/12 h-fit flex flex-col items-start justify-start">
                <p className="w-full h-fit text-[#606060] text-2xl Medium text-justify mb-2 leading-normal">
                ...
                <p className="w-full h-fit text-[#606060] text-2xl Medium text-justify leading-normal">
                ...
                <div className="w-4/12 h-fit flex flex-row items-center justify-center gap-2 mt-6 py-6 px-20 bg-[#548DCA] buttonShadow">
