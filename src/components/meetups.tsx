...
function Meetups() {
  ...
  return (
    <section className="w-full flex flex-col items-center justify-start pt-28 mb-6">
      <h5 className=" text-black text-4xl mb-10 SemiBold leading-normal text-center">
        {t('meetups')}
      </h5>
      <Link href="/meetups" className='w-8/12 xl:w-1/2 h-fit mx-auto '>
        <h6 className=" w-full text-black p-4 bg-white border-4 border-[#eddb55] text-xl xl:text-2xl Medium leading-normal text-center my-6">
          {
            t('meetupsPara')
          } 👇
        </h6>
