...
function Footer(){
    return(
        <footer className="w-full h-fit pt-32 lg:pt-60 flex flex-col items-center justify-start">
            ...
            <div className="w-full h-fit flex flex-col-reverse lg:flex-row items-center justify-between px-4 lg:px-8 py-8 lg:py-14 bg-[#518DCA] relative z-50 mt-3 lg:-mt-5">
