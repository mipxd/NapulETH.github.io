...
function Where() {
    ...
    return (
        <section className="w-full flex flex-col items-center justify-start mt-40">
            ...
            <p className=" text-[#606060] Medium text-3xl text-center leading-normal w-8/12 mb-2">
            ...
            <p className=" text-[#606060] Medium text-3xl text-center leading-normal w-7/12">
                It is here where the infamous Count Dracula is thought to be buried.
            </p>

            <div className="mt-8 w-6/12 h-fit flex flex-row items-center justify-center">
                <Carousel className="w-full h-fit buttonShadow" onChange={(index: number)=>{setSelectedSliderIndex(index)}} showIndicators={false} swipeable interval={3000} autoPlay infiniteLoop showArrows={false} showStatus={false} showThumbs={false} selectedItem={selectedSliderIndex}>
